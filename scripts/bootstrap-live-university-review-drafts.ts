...
async function main() {
  ...
  const universityRows = await db
    .select({
      ...
      clinicalExposure: universities.practicalExposure,
      hostelOverview: universities.hostelOverview,
      indianFoodSupport: universities.dietarySupport,
      ...
      teachingHospitals: universities.industryPartners,
  ...
  const programRows = await db
    .select({
      ...
      licenseExamSupport: programOfferings.professionalExamSupport,
