...
const universities = [
  ...
  },
  {
    ...
    whyChoose: ["official regulatory sources Listed", "European location in Tbilisi", "Compliant 6-year program rules applied"],
  ...
  },
  {
    ...
    officialWebsite: "#",
    summary: "The Critical Care Medicine Institute in Tbilisi is an ultra-specialized medical facility that also provides higher-education medical sciences training under official regulatory sources guidelines.",
    ...
    whyChoose: ["Extremely niche focus on critical care", "official regulatory sources Listed"],
  ...
  },
  {
    ...
    whyChoose: ["Stunning coastal location in Batumi", "official regulatory sources Listed"],
  ...
  },
  {
    ...
    officialWebsite: "#",
    summary: "Caucasus Medicine School operates as an independent, focused medical faculty targeting high clinical competencies acting under the broader official regulatory sources framework.",
    ...
    whyChoose: ["official regulatory sources Listed", "Located in Tbilisi"],
  ...
  },
  {
    ...
    establishedYear: 2001,
    officialWebsite: "#",
    summary: "An incredibly niche academy listed in official regulatory sources exploring the intersection of modern diagnostics with traditional frameworks.",
