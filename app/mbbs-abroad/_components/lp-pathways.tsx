      ...
      <div className="mx-auto max-w-3xl px-4">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-gray-500">
            MBBS abroad is not just an India-return degree. Depending on where
            you want to practice, you can go to the USA, UK, Australia, Canada,
            New Zealand — or do your PG in the same country.
          </p>
        </div>
