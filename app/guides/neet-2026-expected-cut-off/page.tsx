...
const description =
  "A May 12, 2026 expected cut-off planning guide based on NEET's provisional answer key. Use current NTA results and counselling notices for final decisions.";
