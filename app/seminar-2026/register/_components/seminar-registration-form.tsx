  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <Label htmlFor={`${fieldPrefix}-student-name`}>Student name</Label>
        <Input
      ...
      {/* Father name */}
      <div className="space-y-2">
        <Label htmlFor={`${fieldPrefix}-father-name`}>Father's name</Label>
        <Input
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Optional — parent or guardian's contact number
        </p>
      </div>
      ...
      <div className="space-y-2">
        <Label htmlFor={`${fieldPrefix}-event`}>Which event do you want to attend?</Label>
      ...
      {/* Interested Country */}
      <div className="space-y-2">
        <Label htmlFor={`${fieldPrefix}-country`}>Which country are you interested in?</Label>
        <div className="relative">
          <select
      ...
      {/* Budget Range */}
      <div className="space-y-2">
        <Label htmlFor={`${fieldPrefix}-budget`}>Your budget range for MBBS abroad</Label>
        <div className="relative">
          <select
      ...
      {/* Document Upload - Only show if they need 1-on-1 session */}
      {needsSession === "yes" && (
        <>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Required for 1-on-1 session. PDF, JPG, or PNG format. Max size: 5MB
            </p>
          </div>
        </>
      )}
