...
const keyTakeaways = [
  "Yes, NEET is mandatory for Indian students pursuing MBBS in Russia who want medical registration in India. The National Medical Commission (NMC) mandates NEET qualification for all Indian citizens and OCIs studying medicine abroad from the 2019-20 academic year onwards.",
  "Russian universities accept qualifying NEET scores (50th percentile for General category, 40th percentile for SC/ST/OBC). Unlike Indian medical colleges requiring 600+ NEET scores for admission, Russia primarily evaluates Class 12 marks (minimum 50% PCB aggregate) and doesn't use NEET for merit ranking.",
  "The 'MBBS in Russia without NEET' marketing claim is technically possible for university admission but creates India-return complications. Without valid NEET qualification, graduates cannot appear for FMGE/NExT screening exams or obtain medical registration to practice in India, making the degree unusable for Indian medical practice.",
];
...
const mythVsReality = [
  {
    myth: "Russia doesn't require NEET, so Indian students don't need it",
    reality: "Russian universities may admit without NEET, but NMC mandates NEET for India-return medical registration. Admission ≠ registration eligibility.",
    riskLevel: "Critical",
  },
  {
    myth: "Any low NEET score is useless for Russia",
    reality: "Qualifying NEET score (50th/40th percentile) is sufficient. Russia evaluates Class 12 marks primarily; NEET serves regulatory compliance, not merit ranking.",
    riskLevel: "Low",
  },
  {
    myth: "I can skip NEET now and fix it after graduation",
  ...
  {
    myth: "Russian MBBS degree is valid in India regardless of NEET",
    reality: "Degree recognition and medical practice permission are separate. NMC recognizes WHO-listed Russian universities but requires NEET compliance for practice registration.",
    riskLevel: "High",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "Yes, if the student wants to preserve the option of registration and practice in India later. NMC mandates NEET qualification for all Indian citizens and OCIs pursuing medicine abroad from 2019-20 onwards. Russian universities may admit without using NEET for selection, but this doesn't override NMC's India-return eligibility requirements.",
  },
  {
    question: "Can I study MBBS in Russia without NEET?",
    answer:
      "A Russian university may technically admit you without NEET, but this creates critical India-return complications. Without valid NEET qualification at the time of admission, you cannot appear for FMGE/NExT screening exams or obtain NMC medical registration to practice in India, effectively making the degree unusable for Indian medical practice despite being a valid WHO-recognized qualification.",
  },
  {
    question: "How much NEET score is required for MBBS in Russia?",
    answer:
      "Qualifying NEET score is sufficient: 50th percentile for General category (typically 600-650 marks), 40th percentile for SC/ST/OBC categories (typically 550-600 marks). Unlike Indian medical colleges requiring 600+ scores for competitive admission, Russian universities primarily evaluate Class 12 PCB marks (minimum 50% aggregate) and don't use NEET for merit ranking. NEET serves as regulatory compliance for India-return pathway, not admission competition.",
  },
  {
    question: "Is NEET enough on its own for MBBS in Russia admission?",
    answer:
      "No. NEET qualification protects your India-return pathway but doesn't guarantee Russian university admission. Students must also satisfy: Class 12 science background with 50% PCB minimum, valid passport, academic transcripts, medical fitness certificates, visa documentation, and university-specific admission requirements. NEET is a mandatory eligibility criterion, not a sufficient admission guarantee.",
  },
  {
    question: "What happens if my NEET score is low but above the qualifying percentile?",
    answer:
      "Low qualifying NEET scores (just above 50th/40th percentile) are perfectly acceptable for Russia. Families often worry unnecessarily because they compare with Indian MBBS cutoffs (600-720). Russian universities focus on Class 12 academic profile, English proficiency, and overall fit rather than NEET ranking. A 550-mark NEET score with 75% Class 12 marks is often better positioned for quality Russian universities than a 650-mark NEET score with 55% Class 12 marks.",
  },
];
  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-border bg-gradient-to-br from-accent/10 via-background to-background px-6 py-20 sm:px-8 sm:py-24 lg:px-12 lg:py-32">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-6 max-w-3xl text-xl leading-9 text-muted-foreground sm:text-2xl sm:leading-10">
            The direct answer: <strong className="text-foreground">Yes, for Indian students who want medical registration in India.</strong> Russian universities may admit without using NEET for merit ranking, but NMC mandates NEET qualification for the India-return pathway.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            <CounsellingDialog
              ...
              plainTrigger
              title="Need clarity on Russia NEET requirements?"
              description="Our team will help you understand NEET compliance, score requirements, and India-return implications for Russia MBBS."
              ctaVariant="neet-russia-hero"
              courseSlug="mbbs"
              countrySlug="russia"
              notes="Interest: Is NEET required for MBBS in Russia"
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="rounded-3xl border border-accent/20 bg-gradient-to-br from-accent/5 to-background p-8 sm:p-10">
            ...
            <h2 className="font-display text-3xl font-bold text-foreground sm:text-4xl">
              What Indian families must know about NEET and Russia
            </h2>
      ...
      <section className="border-t border-border bg-muted/30 px-6 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-6xl">
          <h2 className="font-display text-3xl font-bold text-foreground sm:text-4xl">
            MBBS in Russia without NEET: separating myth from reality
          </h2>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">
            Many consultants market Russia as a "without NEET" destination. Here's what families need to understand about each common myth and its India-return implications.
          </p>
      ...
      <section className="border-t border-border px-6 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">
            Before paying any Russia admission fees, verify these critical points to avoid costly mistakes that close your India-return pathway.
          </p>
          ...
          <div className="mt-10 rounded-2xl border border-border bg-gradient-to-br from-accent/5 to-background p-8">
            ...
            <p className="mt-4 text-base leading-7 text-muted-foreground">
              If a consultant claims you can study MBBS in Russia without NEET, ask them to put this in writing:{" "}
      ...
      <section className="border-t border-border px-6 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="font-display text-3xl font-bold text-foreground sm:text-4xl">
            Need clarity on Russia NEET requirements for your profile?
          </h2>
          <p className="mt-4 text-lg leading-8 text-muted-foreground">
            Our team can help you understand NEET compliance, score adequacy, NMC eligibility verification, and the right Russia university shortlist based on your actual profile.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <CounsellingDialog
              ...
              plainTrigger
              title="Russia NEET eligibility consultation"
              description="Share your NEET score, Class 12 marks, and career plans. We'll help you understand whether Russia remains viable and which universities match your profile."
              ctaVariant="neet-russia-bottom"
              courseSlug="mbbs"
              countrySlug="russia"
              notes="Interest: Is NEET required for MBBS in Russia - bottom CTA"
            />
            <Link
              href="/mbbs-in-russia"
