...
const AUTHORS = {
  ...
  "rajendra-kumar-deepak": {
    ...
    initials: "RD",
    title: "Co-Founder, Students Traffic",
    bio: "Rajendra Kumar Deepak co-founded Students Traffic with over 15 years of experience guiding students and families through some of the most consequential decisions of their lives — where to study, which university to trust, and how to build a medical career that lasts.",
    ...
    longBio: [
      "Rajendra Kumar Deepak brings more than 15 years of hands-on experience in student advisory, institutional relations, and overseas education to his role as Co-Founder of Students Traffic. He has spent the better part of his career working directly with students and their families at the moment they need clarity most — when they are choosing a path that will define the next decade of their lives.",
