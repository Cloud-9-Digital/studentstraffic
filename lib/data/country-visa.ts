...
const content: Record<string, CountryVisaContent> = {
  "united-states": shared("Most degree-seeking international students use F-1 status after admission to an eligible institution. The designated school official issues Form I-20 after the student's admission and financial requirements are satisfied; the U.S. Department of State and DHS govern the visa and status process.", [
    { title: "Choose an eligible institution and programme", body: "Confirm the institution's international office can sponsor the applicable student status and ask which documents, funding evidence and deadlines apply to the specific programme." },
    { title: "Receive the admission and Form I-20", body: "After admission and financial certification, the designated school official issues Form I-20 for F-1 or M-1 study. Check the name, programme, start date and funding figures immediately." },
    { title: "Pay SEVIS and complete the visa application", body: "Pay the I-901 SEVIS fee when required, complete the DS-160, schedule the U.S. consular interview and follow the current U.S. Department of State instructions for your location." },
    { title: "Attend the interview and travel", body: "Carry the passport, DS-160 confirmation, appointment information, Form I-20, admission letter, SEVIS receipt and financial evidence, plus any documents the consular post requests. Entry is decided by U.S. Customs and Border Protection." },
    { title: "Maintain status after arrival", body: "Arrive within the permitted window, report to the school, keep the SEVIS record and address current, maintain the required course load, and ask the designated school official before changing programme, address or work plans." },
  ], ["Valid passport", "Admission letter", "Form I-20 or applicable immigration document", "I-901 SEVIS fee receipt where required", "DS-160 confirmation and visa appointment documents", "Proof of funds for tuition, fees and living costs", "Academic records and evidence requested by the consular officer"], ["https://travel.state.gov/content/travel/en/us-visas/study/student-visa.html", "https://studyinthestates.dhs.gov/students", "https://studyinthestates.dhs.gov/students/prepare/your-form-i-20", "https://www.ice.gov/sevis/i901" ]),
  ...
  "united-kingdom": shared("Students who need immigration permission normally use the UK Student visa route after receiving a Confirmation of Acceptance for Studies (CAS). Requirements vary with nationality, course level and personal circumstances.", [
    { title: "Confirm the route", body: "Check GOV.UK eligibility, whether the course is eligible for a Student visa, and whether you need ATAS, a tuberculosis test or other evidence." },
    { title: "Accept the offer and receive a CAS", body: "Complete Oxford's conditions and financial declaration so the sponsor can issue the CAS used in the visa application." },
    { title: "Prepare funds and documents", body: "Plan for the course fee shown on the CAS and the current maintenance requirement for study outside London; funds normally need to be held for the required 28-day period." },
    { title: "Apply online and complete checks", body: "Apply through GOV.UK, pay the visa and Immigration Health Surcharge charges, then complete biometrics or the applicable identity-check process." },
    { title: "Arrive and follow conditions", body: "Travel within the permission dates, complete university registration and follow Student visa work and attendance conditions. Post-study options are separate and policy-sensitive." },
  ], ["Valid passport", "CAS from the licensed student sponsor", "Academic evidence if requested", "Financial evidence for fees and maintenance where required", "ATAS certificate or TB test if applicable", "Biometrics and identity documents", "Immigration Health Surcharge and visa application payment"], ["https://www.gov.uk/student-visa", "https://www.gov.uk/student-visa/money", "https://www.gov.uk/student-visa/documents-you-must-provide", "https://www.gov.uk/graduate-visa"]),
