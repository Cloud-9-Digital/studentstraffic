...
const countryContentMap: Record<string, CountryContent> = {
  ...
  germany: {
    quickFacts: [
      ...
      { label: "Language requirement", value: "German B2 — mandatory for all nursing programmes and Anerkennung (non-negotiable)" },
      { label: "Time zone", value: "UTC+1 (CET); UTC+2 in summer (CEST)" },
      { label: "Population", value: "~84 million" },
      { label: "Climate", value: "Temperate oceanic — warm summers (20-30°C), cold winters (0 to -5°C)" },
      { label: "Currency", value: "Euro (EUR)" },
      { label: "EU/Schengen", value: "EU founding member (1957), Schengen Area — German residence permit gives access to 26 Schengen countries" },
      { label: "Nursing law", value: "Pflegeberufegesetz (PflBG) 2020 — unified generalist nursing degree (Pflegefachmann/-frau)" },
      { label: "Main intake", value: "October (Wintersemester); some programmes also April (Sommersemester)" },
      { label: "APS certificate", value: "Required for Indian students — mandatory document verification before German visa application" },
      { label: "Entry-level nurse salary", value: "EUR 2,800-3,800/month gross (TVoD public sector)" },
      { label: "Part-time work", value: "Up to 20 hours/week (120 full days/year) during term; full-time during vacations" },
    ],
    eligibility: {
      intro:
        "German nursing degree programmes require German B2 language proficiency at the point of application — this is an absolute prerequisite and the most common barrier for Indian applicants. Beyond language, eligibility depends on the pathway chosen (direct BSc study or Anerkennung after EU nursing degree). Key requirements for Indian students:",
      items: [
        "German language B2 certificate — mandatory for all nursing programmes (Goethe-Institut B2, telc Deutsch B2, TestDaF 4x4, or DSH 2). No programme will consider an application without this. Begin German language preparation as early as possible — reaching B2 from scratch typically takes 18-24 months of consistent study.",
        "APS (Akademische Prufstelle) certificate — mandatory document verification for all Indian students applying to German universities. Apply at APS India (New Delhi or Chennai). Cost: EUR 150 approx. Processing: 6-10 weeks. The APS certificate must be obtained before the German student visa can be applied for.",
        "Hochschulzugangsberechtigung (HZB) — Germany's university entry qualification. Indian Class 12 alone is generally not sufficient; Germany requires 13 years of schooling (vs India's 12). Options: (A) Indian Class 12 + 1 year of university studies in India = eligible to apply to Studienkolleg (German foundation year); (B) Indian bachelor's degree (any discipline, including BSc Nursing) = full HZB recognised directly.",
        "For Duales Studium Pflege (dual nursing degree): a signed Ausbildungsvertrag (training contract) with a German hospital or nursing care provider is required before university enrolment — the hospital accepts you as an Auszubildende (trainee) and pays EUR 1,000-1,200/month training allowance during the programme.",
        "For Anerkennung route (EU-trained nurses): completed BSc Nursing from an EU-accredited institution (Lithuania, Albania, etc.) + German B2 + VASPVT/equivalent licence + all degree documents with certified German translations + Apostille.",
        "Valid Indian passport (minimum 6 months validity beyond planned study end).",
        "Health insurance: mandatory for all German students (public GKV student insurance approximately EUR 110-140/month for students under 30).",
        "Blocked account (Sperrkonto): EUR 11,208/year (EUR 934/month) must be deposited in a German blocked account as proof of financial means for the student visa — required by all Indian applicants.",
      ],
    },
    admissionSteps: [
    ...
    verificationChecklist: [
      "The German B2 language certificate is from a recognised provider (Goethe-Institut, telc, TestDaF, DSH) and has not expired — most programmes require the certificate to be issued within 2 years of application.",
      "The APS certificate application is submitted at least 10 weeks before the university application deadline to allow for processing time.",
      "The HZB recognition status — Class 12 alone vs Class 12+degree vs bachelor's — is confirmed before any application is submitted, as the wrong pathway wastes the APS fee and application cycle.",
      "For Duales Studium: the hospital training contract specifies the monthly Ausbildungsvergutung (EUR 1,000-1,200), the partner university name, programme start date, and any continuation conditions.",
      "The Sperrkonto amount (EUR 11,208 minimum) is deposited and the bank confirmation letter is available before the visa appointment.",
      "Health insurance enrolment confirmation is obtained before arrival — public GKV student insurance (TK, AOK, Barmer) or private student PKV is mandatory and checked at Immatrikulation.",
    ],
    documentsRequired: {
      educational: [
        "Passport copy (minimum 6 months validity beyond study end)",
        "Class 10 marksheet and certificate — with certified German translation + MEA Apostille",
        "Class 12 marksheet and certificate — with certified German translation + MEA Apostille",
        "Bachelor's degree transcript and certificate (if applicable) — with certified German translation + MEA Apostille",
        "APS certificate (Akademische Prufstelle India) — mandatory for all Indian students",
        "German B2 language certificate (Goethe-Institut B2, telc Deutsch B2, TestDaF 4x4, or DSH 2)",
        "Motivation letter (Motivationsschreiben) in German — tailored to the specific nursing programme",
        "CV / Resume (Lebenslauf) in German — tabular format (tabellarischer Lebenslauf)",
        "Ausbildungsvertrag (training contract with hospital) — for Duales Studium Pflege applicants",
      ],
      visa: [
        "Zulassungsbescheid (university admission letter)",
        "Sperrkonto confirmation (blocked account with EUR 11,208 minimum — Fintiba, Expatrio, or Deutsche Bank)",
        "APS certificate",
        "German B2 language certificate",
        "Valid health insurance confirmation (public GKV or private PKV student plan)",
        "Passport photographs (biometric, 35x45 mm)",
        "German student visa application form (completed)",
        "Visa fee: EUR 75",
        "Proof of accommodation in Germany (Wohnheimzusage or signed lease)",
        "Academic documents (Class 12, degree, APS) — certified German translations + MEA Apostille copies",
      ],
    },
    hostelInfo:
    ...
    costOfLiving: {
      ...
      items: [
        { category: "Studentenwohnheim (student residence)", range: "EUR 200-450/month", notes: "Subsidised; apply immediately on admission. Munich/Frankfurt higher, Leipzig/Dortmund lower." },
        { category: "Private WG (shared flat)", range: "EUR 350-700/month", notes: "Per person; WG-Gesucht.de is the main marketplace. Munich EUR 600-900." },
        { category: "Food and groceries", range: "EUR 200-350/month", notes: "Aldi, Lidl, Rewe, Netto — budget supermarkets widely available. Cooking at home essential." },
        { category: "Semester contribution (transport included)", range: "EUR 150-500/semester", notes: "Paid twice yearly. Includes Deutschlandticket in most states (unlimited regional public transport)." },
        { category: "Health insurance (GKV student)", range: "EUR 110-140/month", notes: "Mandatory. Techniker Krankenkasse (TK) or AOK widely used by international students under 30." },
        { category: "Phone and internet", range: "EUR 20-40/month", notes: "German SIM (Telekom, Vodafone, O2) or MVNO (Aldi Talk, Lidl Connect)." },
        { category: "Books and materials", range: "EUR 30-60/month", notes: "Nursing textbooks can be expensive; university library access reduces costs significantly." },
        { category: "Miscellaneous / personal", range: "EUR 80-150/month", notes: "Clothing, recreation, personal care, city activities." },
        { category: "Monthly total (student residence)", range: "EUR 810-1,290/month", notes: "Excluding one-time Sperrkonto requirement. Dual-study students offset EUR 1,000-1,200 via training allowance." },
        { category: "Monthly total (private WG)", range: "EUR 990-1,590/month", notes: "Comfortable lifestyle in a major German city. Plan higher for Munich and Frankfurt." },
      ],
    },
    careerOpportunities: [
      "Registered Pflegefachmann/-frau (Germany): Register with the Landespflegekammer of your federal state after graduation and German B2 certification. Entry-level salary: EUR 2,800-3,800/month gross (TVoD P7-P8). Experienced nurses (3+ years): EUR 3,500-4,500/month. Specialist nurses (ICU, anaesthesia, oncology): EUR 4,000-5,500/month. Night shift and weekend supplements add 15-25% on top of base salary.",
      "Germany to permanent residency: after 2 years of skilled nursing employment, apply for Niederlassungserlaubnis (permanent residence). After 3 years for exceptional integration (language C1, pension contributions, no welfare dependency). Permanent residency enables EU Blue Card mobility across the EU.",
      "DACH region mobility: Germany, Austria, and Switzerland (DACH region) share mutual nursing qualification recognition. After obtaining German registration, practice in Austria (Gesundheits- und Krankenpfleger) or Switzerland (SBK registration) without re-examination. Swiss nursing salary: CHF 5,500-7,500/month — among the highest in Europe.",
      "Specialisation in Germany: after 2 years of general nursing practice, German nurses can access 2-year specialist training (Fachweiterbildung) in ICU/CCU, anaesthesia, oncology, paediatrics, psychiatry, or geriatrics — each adding EUR 300-600/month to base salary.",
