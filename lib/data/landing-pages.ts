...
export const landingPages: LandingPage[] = [
  ...
  },
  {
    ...
    kicker: "Leading destination for English-medium medical studies",
    summary:
      "A premier destination offering top-tier medical universities, world-class infrastructure, and a multicultural environment for international students.",
    heroHighlights: [
      "Highly recognized medical programs",
      "Modern universities",
      "NMC-compliant options",
      "Multinational student community",
    ],
    reasonsToChoose: [
      "High academic standards combined with accessible fee structures",
      "Focuses on English-medium instruction from the first year",
      "Excellent connectivity with India and straightforward admission pathways",
    ],
    editorialNotes: [
      "Ensure you evaluate the availability of Indian hostels and food while choosing.",
      "A great option for students prioritizing quality and a modern lifestyle.",
    ],
    featuredUniversitySlugs: [
    ...
    faq: [
      {
        ...
        answer:
          "Yes — graduates from NMC-compliant Kazakhstani universities can sit FMGE/NExT to practise medicine in India. Recognition is university-specific. Kazakh National Medical University, Astana Medical University, and Karaganda Medical University are among the well-documented NMC-compliant options — always verify the specific university on the NMC portal before enrolling.",
      },
      {
        question: "What is the fee range for MBBS in Kazakhstan?",
        answer:
          "Annual tuition at Kazakhstani medical universities ranges from $4,000 to $7,500. Hostel costs run $50–100/month and living expenses $150–250/month. The total 6-year all-in cost typically falls between ₹30–55 lakh — competitive with Russia and significantly below Indian private medical colleges.",
      },
      {
        question: "Is NEET required for MBBS in Kazakhstan?",
        answer:
          "Kazakhstani universities do not require NEET for admission. However, Indian students who plan to practise in India must have a valid NEET-UG scorecard before their MBBS program begins — an NMC requirement regardless of where you study. Without NEET, you cannot sit FMGE/NExT and cannot register with any Indian medical council.",
      },
      {
        question: "What language is MBBS taught in at Kazakhstan universities?",
        answer:
          "Kazakhstan is one of the few countries where English-medium instruction is genuinely established from year one at the top universities — students do not need Russian or Kazakh for theory. However, Kazakh or Russian language classes are included in the curriculum for clinical interaction. Medical communications in hospitals in cities like Almaty and Astana increasingly use English in international student rotations.",
      },
      {
        question: "Should I choose a 5-year or 6-year MBBS program in Kazakhstan?",
        answer:
          "Always choose the 6-year program, which includes the internship year. The NMC requires a minimum 54-month course plus a 12-month internship for Indian students studying abroad. Some universities occasionally market 5-year options — these may not comply with NMC requirements and can disqualify graduates from the FMGE/NExT pathway.",
      },
      {
        question: "How cold is Kazakhstan — can Indian students manage?",
        answer:
          "Astana (now Astana) is one of the coldest capital cities in the world, with temperatures reaching -25°C to -35°C in January and February. Almaty is milder. University buildings, hostels, and metro systems are centrally heated — the main challenge is the commute between buildings. Investing in quality winter gear before arrival is essential. Most Indian students adapt within the first winter.",
      },
      {
        question: "Are there Indian food and community options in Kazakhstan?",
        answer:
          "Yes — cities like Almaty and Astana have well-established Indian student communities with Indian restaurants, mess facilities, and student associations. Supermarkets carry Indian spices and pulses. Students who prefer cooking at home find ingredients readily available in major city markets.",
      },
    ],
    metaTitle: "MBBS in Kazakhstan 2026 | Fees, Universities & Admission",
    metaDescription:
      "Compare MBBS in Kazakhstan's affordable fee structures, English-medium medical programs, and step-by-step admissions context.",
    intakeTimeline: [
      { milestone: "Application Opens", timeline: "June - July", details: "Initial documents (10th/12th marksheets) submitted." },
      { milestone: "Admission Letter", timeline: "July - August", details: "University issues the official acceptance letter." },
      { milestone: "Visa Stamping", timeline: "August - September", details: "Visa Processing." },
      { milestone: "Departure & Classes", timeline: "October", details: "Pre-departure briefings and flights to Kazakhstan." },
    ],
    livingCostBreakdown: [
      { item: "Accommodation (Hostel)", cost: "$50 – $100 / month" },
      { item: "Food & Groceries", cost: "$100 – $150 / month" },
      { item: "Transport", cost: "$10 – $20 / month" },
      { item: "Miscellaneous", cost: "$30 – $60 / month" },
    ],
    challenges: [
      {
        title: "5-Year vs 6-Year Ambiguity",
        realityCheck: "Some universities occasionally offer 5-year programs. Ensure you enroll in a 6-year program (including internship) to strictly adhere to NMC rules.",
      },
      {
        title: "Climate",
        realityCheck: "Extremely cold winters similar to Russia, requiring proper winter gear.",
      },
    ],
  },
  {
