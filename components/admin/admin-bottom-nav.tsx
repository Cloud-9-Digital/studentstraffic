...
import { BarChart3, FileSearch, LayoutDashboard, MessageCircleMore, MessageSquareQuote, NotebookPen, SendHorizontal, Users, Users2, WalletCards } from "lucide-react";
...
const navigation = [
  ...
  { href: "/admin/lead-delivery", label: "Jobs", icon: SendHorizontal, ownerOnly: false },
  ...
  { href: "/admin/university-research", label: "Research", icon: FileSearch, ownerOnly: false },
