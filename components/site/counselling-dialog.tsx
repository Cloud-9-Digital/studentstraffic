...
export function CounsellingDialog({
  ...
  plainTrigger = false,
  onTriggerClick,
  title = "Book your admissions call",
  description = "Leave your number — we'll call you and tell you exactly which university to apply to based on your NEET score, budget, and destination preference.",
  submitLabel,
