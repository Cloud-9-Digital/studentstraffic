        ...
        {state.success ? (
          ...
          <div className="p-6 text-center">
            ...
            <div className="relative mx-auto mb-5 size-20">
              <span className="absolute inset-0 rounded-full bg-emerald-400 animate-ring-out" />
              <div className="animate-pop-in flex size-20 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-200">
                <BadgeCheck className="size-10 text-white" strokeWidth={1.75} />
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 text-left space-y-2.5 mb-5">
              <div className="flex items-start gap-2.5">
                <svg className="mt-0.5 size-4 shrink-0 text-emerald-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <div className="flex items-start gap-2.5">
                <Mail className="mt-0.5 size-4 shrink-0 text-[#c2410c]" />
                <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <button
              ...
              className="w-full rounded-xl bg-[#c2410c] py-2.5 text-sm font-semibold text-white hover:bg-[#9a3412] transition-colors"
            >
              Done
            </button>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mb-5 flex items-center gap-3 rounded-xl bg-slate-50 px-4 py-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-slate-500 truncate">{peer.universityName}</p>
              </div>
            </div>
...
export function StudentCard({ peer }: { peer: PeerWithUniversity }) {
  ...
  return (
    <>
      <div className="flex flex-col rounded-2xl border border-slate-200 bg-white transition-all hover:border-[#c2410c]/30 hover:shadow-sm group">

        {/* Avatar + identity */}
        <div className="flex flex-col items-center px-4 pt-6 pb-4 text-center gap-3">

          {/* Avatar with subtle accent ring */}
          <div className="ring-[3px] ring-[#c2410c]/15 ring-offset-2 rounded-full">
          ...
          {(peer.courseName || peer.currentYearOrBatch) && (
            <div className="flex flex-wrap items-center justify-center gap-1">
              {peer.courseName && (
                <span className="rounded-md bg-orange-50 px-2 py-0.5 text-[11px] font-semibold text-[#c2410c]">
                  {peer.courseName}
                </span>
              )}
        ...
        <div className="mt-auto border-t border-slate-100 px-4 py-3.5">
          {peer.hasWhatsApp ? (
            <button
              ...
              className="w-full rounded-xl bg-[#c2410c] py-2 text-xs font-semibold text-white transition-colors hover:bg-[#9a3412] group-hover:shadow-sm"
            >
              Talk to {firstName}
            </button>
          ) : (
