...
export function LpEligibility({ countryName, documents }: Props) {
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mb-10 text-center">
          <h2 className="font-display text-4xl font-semibold tracking-tight md:text-5xl" style={{ color: "#0f3d37" }}>
            Am I eligible for MBBS in {countryName}?
          </h2>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs leading-6 text-white/60">
                    After finishing MBBS in {countryName}, you must pass the FMGE exam
