...
const steps = [
  { num: "01", title: "Call us or fill the form", desc: "Share your NEET score, budget, and your target intake. Takes 2 minutes." },
  { num: "02", title: "We give you the right universities", desc: "Our team gives you 3 to 5 universities that match your score and budget. No confusion." },
