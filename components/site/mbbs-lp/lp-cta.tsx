...
export function LpCta({ sourcePath, countryName, universityCount }: Props) {
  return (
    <section
          ...
          <div>
            <h2 className="font-display text-4xl font-semibold leading-[1.1] text-white md:text-5xl">
              ...
              <span style={{ backgroundImage: "linear-gradient(90deg, #F5A623 0%, #f9c46a 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                MBBS seat in {countryName} confirmed?
              </span>
            </h2>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
              {[
                ...
                { n: `${universityCount}+`, l: `Universities in ${countryName}` },
                { n: "Since 2014", l: "In This Field" },
                { n: "Free", l: "Counselling Call" },
              ].map(({ n, l }) => (
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
            ...
            <div className="bg-white p-6">
              <LeadForm
                ...
                ctaVariant="country-lp-bottom-cta"
                title=""
                description=""
