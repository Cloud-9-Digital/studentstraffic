...
const NAV_ITEMS: Array<{ label: string; section: ProgramSection | null }> = [
  { label: "Academics", section: null },
...
export function ProgramPageNav({
  programSlug,
  activeSection,
  onSectionChange,
}: {
  ...
  onSectionChange?: (section: ProgramSection | null) => void;
}) {
  return (
